...
import { PlanCards } from "@/components/sections/pricing";
import { Badge, Container, SectionHead } from "@/components/ui";
import { getGlobalContent, getHomeContent, getPricingTableContent } from "@/lib/content";
      ...
      <main className="pb-24">
        <Container>
          ...
          <Reveal className="mt-12 rounded-[22px] border border-line bg-surface px-6 py-10 sm:px-10">
            <h2 className="text-center text-[24px] font-medium tracking-[-0.01em] text-ink">
              {data.extras.heading}
            </h2>
