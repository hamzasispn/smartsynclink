...
export function Intro({ data }: { data: HomeContent["intro"] }) {
  return (
    <section id="conversion" className="bg-page py-24 lg:py-28">
      <Container>
        <div className="grid items-center gap-20 lg:grid-cols-2 lg:gap-40">
          <div>
            <h2 className="text-[40px] font-medium leading-[1.2] tracking-[-0.02em] text-ink sm:text-[40px]">
              {data.heading}
            </h2>
            <p className="mt-9 text-[16px] leading-[1.9] text-muted">{data.body}</p>
            ...
            <p className="mt-6 text-[16px] leading-[1.9] text-muted">{data.body2}</p>
