...
import type { RateGroup, UsagePricingContent } from "@/content/pricing-pages";
...
/** Transparent usage pricing: the title, every rate table with its note, and the closing card. */
export function UsagePricing({ data }: { data: UsagePricingContent }) {
  return (
      ...
      <Container>
        ...
        <div className="mx-auto mt-16 flex max-w-[1000px] flex-col gap-16">
          ...
          <Reveal className="rounded-[22px] bg-gradient-to-r from-[#052EFF] to-[#3300EA] px-8 py-10 text-center text-white">
            ...
            <p className="mx-auto mt-3 max-w-[64ch] text-[15px] leading-[1.7] text-white/85">{data.closing.body}</p>
            <Link
